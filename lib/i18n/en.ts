const en = {
	...
	"chat.step.vector": "Running vector retrieval",
	"chat.step.keyword": "Running keyword retrieval",
	"chat.step.database": "Running database retrieval",
	"chat.step.evaluate": "Evaluating response",
	"chat.step.refine": "Refining response",
	"chat.step.synthesize": "Synthesizing",
	...
	"home.feature3.desc": "Every conversation is saved automatically, making it easy to revisit past questions, continue ongoing discussions, and keep important information within reach.",
	"home.feature4.title": "Answers You Can Verify",
	"home.feature4.desc": "Every answer includes links back to the original DKU sources. Open the official page, view the referenced passage, and explore the information for yourself.",
	"home.feature5.title": "Explore Campus with an Interactive Map",
	"home.feature5.desc": "Find buildings, offices, printers, events, and essential campus services. Explore the map, learn more about any location, and continue the conversation with ChatDKU.",
} as const;
